    ...
    >
      <div className="container mx-auto">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            <h1 className="font-serif text-6xl md:text-7xl text-[#3A2E2A] font-bold leading-tight animate-text-reveal" style={{ animationDelay: '0.2s' }}>
              BIANCA MOURA
            </h1>
            ...
            <div className="flex gap-4 pt-4">
              ...
              <a
                href="https://pag.ae/81vUL4Buv"
                target="_blank"
                rel="noopener noreferrer"
                className="border-2 border-[#C6A75E] text-[#3A2E2A] px-8 py-4 rounded-lg hover:bg-[#C6A75E] hover:text-white transition-all duration-300 shadow-lg hover:shadow-xl hover:-translate-y-1"
              >
                Agendar Horário
              </a>
            </div>
          ...
          >
            <div className="relative animate-float">
              ...
              />
              <div className="absolute -bottom-6 -right-6 w-32 h-32 bg-[#C6A75E] opacity-25 rounded-full blur-3xl" style={{ animation: 'pulse 3s ease-in-out infinite' }}></div>
              <div className="absolute -top-6 -left-6 w-40 h-40 bg-[#C6A75E] opacity-15 rounded-full blur-3xl" style={{ animation: 'pulse 4s ease-in-out infinite 0.7s' }}></div>
            </div>
          </div>
        </div>
      </div>
